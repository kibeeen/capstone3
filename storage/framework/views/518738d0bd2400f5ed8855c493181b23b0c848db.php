				...
				<div class="panel-body">
					...
					<form class="form-horizontal" action='/matches/update/' method="post">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-6">
						      	<select class="form-control" id="update_match_league_id" name='update_match_league_id' required>
						...
						<div class="form-group">
						    <label class="control-label col-sm-2" for="update_team_score">Home TeamScore : </label>
