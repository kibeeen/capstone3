				...
				<div class="panel-body">
					<form class="form-horizontal" action='/leagues/add/' method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-4">
						      	<input type="file" class="form-control-file" id="add_league_banner" name='add_league_banner'>
						    </div>
						</div>
				...
				<div class="panel-body">
					<form class="form-horizontal" action='/leagues/edit/' method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-4">
						      	<input type="file" class="form-control-file" id="edit_league_banner" name='edit_league_banner'>
						    </div>
						</div>
