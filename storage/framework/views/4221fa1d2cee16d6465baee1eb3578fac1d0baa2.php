				...
				<div class="panel-body">
					...
					<?php echo e(csrf_field()); ?>
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-4">
						      	<input type="file" class="form-control-file" id="add_team_logo" name='add_team_logo' accept='image/*'>
						    </div>
						</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php echo e(csrf_field()); ?>
						...
						<div class="form-group">
						  	<label for="select_team_name" class="control-label col-sm-2">Select Team :</label>
						  	<div class="col-sm-4">
							  	<select class="form-control" id="select_team_name" name='select_team_name' required>
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-2">
						      	<input type="text" class="form-control" id="edit_team_abv" name='dd_team_abv' placeholder='Short name' required disabled>
						    </div>
						</div>
						<div class="form-group">
						    <label class="control-label col-sm-2" for="edit_team_logo">Team Logo :</label>
						    <div class="col-sm-4">
						      	<input type="file" class="form-control-file" id="edit_team_logo" name='edit_team_logo' accept='image/*' disabled>
						    </div>
						</div>
...
<script type="text/javascript">
	...
	$('#select_team_name').change(function(){

		$.post("/api/displayTeam/",

	    {
	    	_token : token,
	        team_name: $('#select_team_name').val(),
